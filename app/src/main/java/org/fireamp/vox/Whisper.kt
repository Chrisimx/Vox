...
class Whisper private constructor(private var ptr: Long) {
    ...
    companion object {
        fun createContextFromFile(filePath: String): Whisper {
        ...
        fun createContextFromInputStream(stream: InputStream): Whisper {
        ...
        fun createContextFromAsset(assetManager: AssetManager, assetPath: String): Whisper {
